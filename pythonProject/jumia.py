...
import smtplib
MY_EMAIL = "benardbill@yahoo.co.uk"
...
if price_as_float <25000:
    connection = smtplib.SMTP("smtp.gmail.com")
    connection.starttls()
    connection.login(user=MY_EMAIL, password=MY_PASS)
    connection.sendmail(from_addr=MY_EMAIL, to_addrs=MY_EMAIL, msg=f"subject: Please check on jumia for best price \n"
                                                                   f"Check Jumia and buy now for best price")
    connection.close()
